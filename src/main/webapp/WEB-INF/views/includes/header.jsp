...
<head>
  ...
  <title>for Communication!</title>
  
  <link rel="shortcut icon" href="/resources/startbootstrap-sb-admin-2-gh-pages/img/favicon.ico" type="image/x-icon">
  <link rel="icon" href="/resources/startbootstrap-sb-admin-2-gh-pages/img/favicon.ico" type="image/x-icon">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">Community<sup>v0.1</sup></div>
      </a>
