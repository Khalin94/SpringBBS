...
<div class="card shadow mb-4">
	...
	<div class="card-body">
			...
			<form id="operForm" action="/devBoard/modify" method="get">
...
<script type="text/javascript" src="/resources/js/devReply.js"></script>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("button[data-oper='modify']").on("click", function(e){
			operForm.attr("action", "/devBoard/modify").submit();
		});
		
		$("button[data-oper='list']").on("click", function(e){
			operForm.find("#bno").remove();
			operForm.attr("action", "/devBoard/list").submit();
		});
	});
</script>
